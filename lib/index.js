...
exports.serverAddIn = create_server_1.serverAddIn;
const helmet_1 = require("./addins/helmet");
exports.helmetAddIn = helmet_1.helmetAddIn;
const logging_1 = require("./addins/logging");
exports.log4jsAddIn = logging_1.log4jsAddIn;
const sessions_1 = require("./addins/sessions");
exports.sessionAddIn = sessions_1.sessionAddIn;
const cloudant_store_1 = require("./addins/cloudant-store");
exports.cloudantStoreAddIn = cloudant_store_1.cloudantStoreAddIn;
const passport_initialize_1 = require("./addins/passport-initialize");
exports.passportInitializeAddIn = passport_initialize_1.passportInitializeAddIn;
const appid_webstrategy_1 = require("./addins/appid-webstrategy");
exports.appIdAddIn = appid_webstrategy_1.appIdAddIn;
let _addins = [logging_1.log4jsAddIn, helmet_1.helmetAddIn, cloudant_store_1.cloudantStoreAddIn, sessions_1.sessionAddIn, appid_webstrategy_1.appIdAddIn, passport_initialize_1.passportInitializeAddIn, create_server_1.serverAddIn];
...
function CreateCFServer(configuration, addins) {
    ...
    _addins = _addins.filter((addIn) => !addIn.disabled).sort((a, b) => {
