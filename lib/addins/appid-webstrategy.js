...
var AppIdConfigNames;
(function (AppIdConfigNames) {
    AppIdConfigNames["APPID_OFF"] = "noSignOn";
    AppIdConfigNames["APPID_TENANT_ID"] = "appIdTenantId";
    AppIdConfigNames["APPID_CLIENT_ID"] = "appIdClientId";
    AppIdConfigNames["APPID_SECRET"] = "appIdSecret";
    AppIdConfigNames["APPID_OAUTH_SERVER_URL"] = "appIdOauthServerUrl";
})(AppIdConfigNames = exports.AppIdConfigNames || (exports.AppIdConfigNames = {}));
...
class AppIdAddInImpl extends index_1.BasicAddIn {
    ...
    addIn(server, addIns) {
        ...
        const webappStrategyOptions = !config.get(AppIdConfigNames.APPID_TENANT_ID) ? {} : {
